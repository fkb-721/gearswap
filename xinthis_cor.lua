...
function init_gear_sets()
...
}   range={ name="Compensator", augments={'DMG:+12','AGI+12','Rng.Acc.+12',}},
    ...
    back={ name="Camulus's Mantle", augments={'STR+20','Accuracy+20 Attack+20','Weapon skill damage +10%','Damage taken-1%',}},
}
    ...
    sets.precast.WS['Requiescat'] = set_combine(sets.precast.WS['Swift Blade'], { left_ring="Stikini Ring",
    ...
    sets.Ataktos = {ranged="Anarchy +2"}

    sets.Piercing = { main={ name="Rostam", augments={'Path: B',}},
    sub="Gleti's Knife",
}
