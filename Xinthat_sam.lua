...
-- Heads Up Display --
HUDposX			=	600		--	X position for the HUD. 0 is left of the window, increasing this number will move it to the right.
HUDposY			=	10		--	Y position for the HUD. 0 is top of the window, increasing this number will move it downward.
...
WeaponCycle = {
	...
	{"Ternion Dagger +1", "Deliverance +1"},
	{empty, empty},
	{empty, empty},
	--{"Main Slot", "Sub Slot"},
}
...
sets.hasso.Mode1 = {
    ...
    back={ name="Smertrios's Mantle", augments={'DEX+20','Accuracy+20 Attack+20','DEX+9','"Store TP"+10','Phys. dmg. taken-10%',}},
...
sets.weapon_skill = {
    ...
    back={ name="Smertrios's Mantle", augments={'STR+20','Accuracy+20 Attack+20','Accuracy+10','Weapon skill damage +10%',}},
...
-- Tachi: Kasha (str)
sets["Tachi: Kasha"] = set_combine(sets.weapon_skill, {
    ammo="Knobkierrie",
    head="Mpaca's Cap",
    body={ name="Nyame Mail", augments={'Path: B',}},
    hands={ name="Nyame Gauntlets", augments={'Path: B',}},
...
-- Shikikoyo
sets.shikikoyo = { legs={ name="Sakonji Haidate +2", augments={'Enhances "Shikikoyo" effect',}},

}

-- Blade Bash
sets.blade_bash = { hands={ name="Sakonji Kote +3", augments={'Enhances "Blade Bash" effect',}},


}

-- Sengikori
sets.sengikori = {feet={ name="Sak. Sune-Ate +2", augments={'Enhances "Meikyo Shisui" effect',}},
...
-- Warding Circle
sets.warding_circle = { head="Wakido Kabuto +1",
}

-- Meikyo Shisui
sets.meikyo_shisui = {feet={ name="Sak. Sune-Ate +2", augments={'Enhances "Meikyo Shisui" effect',}},
