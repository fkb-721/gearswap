...
function init_gear_sets()
    ...
    back={ name="Smertrios's Mantle", augments={'STR+2','Accuracy+10 Attack+10','"Store TP"+10','Phys. dmg. taken-2%',}},
}
    ...
    sets.engaged = {
    main={ name="Fusenaikyo", augments={'Path: C',}},
    sub="Nepenthe Grip",
    ammo="Aurgelmir Orb",
    head="Gefechtschaller",
    body={ name="Sakonji Domaru +1", augments={'Enhances "Overwhelm" effect',}},
