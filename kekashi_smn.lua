...
Page			=	'4'		--[1-10/Off]	Sets your Macro page to any number from 1 to 10 (or Off) on file load.
...
sets.idle = { ammo="Sancus Sachet +1",
    ...
    feet={ name="Apogee Pumps +1", augments={'MP+40','Pet: "Mag.Atk.Bns."+25','Blood Pact Dmg.+6',}},
    neck="Chrys. Torque",
...
sets.summoning = set_combine(sets.fast_cast, { ammo="Sancus Sachet +1", body="Baayami Robe +1"})
...
sets.bp_rage_physical = {
    main={ name="Espiritus", augments={'Enmity-6','Pet: "Mag.Atk.Bns."+29','Pet: Damage taken -3%',}},
    sub="Niobid Strap",
    ammo="Sancus Sachet +1",
    head="Baayami Hat +1",
    body="Beckoner's Doublet",
...
sets.bp_rage_magical = {
    ...
    hands="Baayami Cuffs +1",
    legs="Beck. Spats +1",
    feet={ name="Psycloth Boots", augments={'Pet: Mag. Acc.+20','Pet: "Mag.Atk.Bns."+20','Pet: Enmity+7',}},
    neck="Empath Necklace",
    waist="Klouskap Sash +1",
    left_ear="Kyrene's Earring",
    left_ring="Varar Ring",
...
sets.sandoria = set_combine(sets.town, {body="Kingdom Aketon",})
