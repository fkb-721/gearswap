...
-- Heads Up Display --
HUDposX			=	560		--	X position for the HUD. 0 is left of the window, increasing this number will move it to the right.
HUDposY			=	10		--	Y position for the HUD. 0 is top of the window, increasing this number will move it downward.
HUDposY			=	20		--	Y position for the HUD. 0 is top of the window, increasing this number will move it downward.
...
WeaponCycle = {
	{"Tizona","Sakpata's Sword"},
	{"Tizona", "Tanmogayi +1"},
	{"Naegling", "Tizona"},
	{"Naegling", "Maxentius"},
	{"Maxentius", "Mafic Cudgel"},
	{"Machaera +2", "Neagling"},
	--{"Main Slot", "Sub Slot"},
}
...
sets.Mode1.melee = {
    ...
    feet={ name="Herculean Boots", augments={'"Triple Atk."+3','Accuracy+10',}},
...
sets.snapshot = { waist="Yemaya Belt"
...
-- Breath
-- Combines with Magical set, only necessary to set the slots with specific desired stats
sets.breath = set_combine(sets.magical, {  head={ name="Luh. Keffiyeh +1", augments={'Enhances "Convergence" effect',}},
...
sets.chain_affinity = { head="Hashishin Kavuk +2",
}
...
-- Efflux
sets.efflux = {
	legs="Hashishin Tayt +1", back={ name="Rosmerta's Cape", augments={'DEX+20','Accuracy+20 Attack+20','DEX+8','"Store TP"+10','Phys. dmg. taken-10%',}},
}
