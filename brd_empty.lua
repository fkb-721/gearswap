...
function user_setup()
    ...
    state.WeaponSet = M{['description']='Weapon set', 'Kali',}
	...
	send_command('bind !h gs c cycle Weaponset')
	send_command('bind !g gs c cycleback Weaponset')
